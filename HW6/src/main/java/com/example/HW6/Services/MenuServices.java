...
import com.example.HW6.Models.MenuModels;
...
public class MenuServices {
    ...
    public void showMenu(){
        System.out.println(MenuModels.CHOOSE);
        System.out.println(MenuModels.FIRST_OPTION);
        System.out.println(MenuModels.SECOND_OPTION);
        System.out.println(MenuModels.THIRD_OPTION);
        System.out.println(MenuModels.FOURTH_OPTION);
        System.out.println(MenuModels.FIFTH_OPTION);
    }
